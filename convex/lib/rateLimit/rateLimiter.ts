...
const rateLimits = {
  ...
  taskLinkSetHandedIn: { kind: "token bucket" as const, rate: 240, period: HOUR, capacity: 60 },
  ...
  assignmentSetReleased: { kind: "token bucket" as const, rate: 60, period: HOUR, capacity: 30 },

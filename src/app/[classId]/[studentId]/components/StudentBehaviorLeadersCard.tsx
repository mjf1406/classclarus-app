// File: StudentBehaviorLeadersCard.tsx
    ...
    <CardContent className="space-y-6">
      ...
      <div>
        ...
        {topPositive.length !== 0 && (
          <p className="mt-2 text-sm text-gray-700 dark:text-gray-200">
            These are the positive behaviors where you&apos;re ranked #1 in the
            whole class! Keep up the great work! You&apos;re crushing it! 💪
          </p>
        )}
        {topPositive.length === 0 ? (
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            You&apos;re not #1 in any positive behaviors. YET! Just keep working
            hard and I&apos;m sure you&apos;ll get there soon! You can do it! 😁
          </p>
        ) : (
      ...
      <div>
        ...
        {topNegative.length !== 0 && (
          <p className="mt-2 text-sm text-gray-700 dark:text-gray-200">
            These are the negative behaviors where you&apos;re ranked #1 in the
            whole class. I know you can do better. Think carefully before doing
            one of the below again. 🥺
          </p>
        )}
        {topNegative.length === 0 ? (
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            Congratulations! You&apos;re so well-behaved because you&apos;re not
            #1 in any negative behaviors! Keep being awesome 😁
          </p>
        ) : (
          <ul className="mt-4 space-y-3">

...
import { createAssigner } from "../../actions/randomAssigner";
...
export default function CreateAssignerDialog() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(`Created the Assigner named ${name}!`);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {type && (
            <div className="space-y-2">
              ...
              <div className="bg-accent text-background flex items-center gap-2 px-2 py-1">
                <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1">
                  {groups.map((group, index) => (
                    <div
                      key={group.id}
                      className="bg-foreground/10 flex w-full items-center gap-2 p-1 sm:w-[calc(50%-0.5rem)] md:w-[calc(33%-0.5rem)] lg:w-[calc(25%-0.5rem)]"
                    >
                      <Input
                        value={group.name}
                        onChange={(e) =>

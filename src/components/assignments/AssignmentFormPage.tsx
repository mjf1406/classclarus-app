                          ...
                          >
                            <div className="flex items-start justify-between gap-2">
                              <form.Field name={`sections[${index}].name`}>
                                {(nameField) => {
                                  const error = fieldErrorMessage(nameField.state.meta.errors);
                                  return (
                                    <Field
                                      className="flex-1"
                                      data-invalid={error ? true : undefined}
                                    >
                                      <FieldLabel>{t("sectionNameLabel")}</FieldLabel>
                                      <Input
                                ...
                                <div className="flex flex-col gap-3">
                                  <Field>
                                    ...
                                    <Select
                                      ...
                                      onValueChange={(value) => {
                                        ...
                                        typeField.handleChange(value as AssignmentSectionType);
                                        if (value === "rubricLevels") {
                                          const levels = form.getFieldValue(
                                            `sections[${index}].levels`,
                                          );
                                          if (!levels || levels.length === 0) {
                                            form.setFieldValue(`sections[${index}].levels`, [
                                              createEmptyRubricEntry(),
                                            ]);
                                          }
                                        }
                                  ...
                                  {typeField.state.value === "points" ? (
                                    <form.Field name={`sections[${index}].maxPoints`}>
                                      {(pointsField) => (
                                        <Field>
                                          <FieldLabel>{t("sectionMaxPointsLabel")}</FieldLabel>
                                          <NumberInput
                                  ...
                                  {typeField.state.value === "rubricLevels" ? (
                                    <form.Field name={`sections[${index}].levels`} mode="array">
                                      {(levelsField) => {
                                        ...
                                        return (
                                          <div className="flex flex-col gap-2">
                                            ...
                                            {levelsField.state.value.map((level, levelIndex) => (
                                              <div
                                                key={level.key}
                                              ...
                                              >
                                                ...
                                                <Button
                                                  ...
                                                  onClick={() =>
                                                    levelsField.removeValue(levelIndex)
                                                  }
                                                >
                                                  <Trash2 className="size-4" />
                                                </Button>
                                            ...
                                            <Button
                                              ...
                                              className="w-fit"
                                              onClick={() =>
                                                levelsField.pushValue(createEmptyRubricEntry())
                                              }
                                            >
                                  ...
                                  {typeField.state.value === "rubricCheckboxes" ? (
                                    <form.Field name={`sections[${index}].items`} mode="array">
                                      {(itemsField) => {
                                        ...
                                        return (
                                          <div className="flex flex-col gap-2">
                                            ...
                                            <Button
                                              ...
                                              className="w-fit"
                                              onClick={() =>
                                                itemsField.pushValue(createEmptyRubricEntry())
                                              }
                                            >
                                              <Plus className="size-4" />
                                              {t("checkboxAdd")}

...
const de: Catalog = {
  ...
  auth: {
    ...
    and: "und",
    googleOnlyNote: "Derzeit unterstützen wir nur Google. Weitere Optionen folgen.",
  ...
  home: {
    ...
    sortByFieldActive: "Nach {{field}} sortieren, {{direction}}. Klicken zum Umkehren.",
  ...
  join: {
    ...
    description: "Verwenden Sie den Code Ihres Lehrers oder eine Erziehungsberechtigten-Einladung.",
    submit: "Beitreten",
  ...
  classes: {
    ...
    yearLabel: "Schuljahr",
    yearImmutable: "Das Schuljahr kann nach dem Erstellen der Klasse nicht geändert werden.",
    ...
    deleteClassDescription: "„{{name}}“ löschen? Dies kann nicht rückgängig gemacht werden.",
    ...
    downloadGuardianCodePdf: "PDF mit Erziehungsberechtigten-Codes herunterladen",
    downloadGuardianCodePdfAria: "PDF mit Erziehungsberechtigten-Codes herunterladen",
    ...
    regenerateGuardianFor: "Erziehungsberechtigten-Code für {{name}} regenerieren",
    ...
    guardianCodeRegenerated: "Erziehungsberechtigten-Code für {{name}} regeneriert",
    guardianCodeRegenerateFailed: "Regenerieren des Erziehungsberechtigten-Codes fehlgeschlagen",
    removeGuardianTitle: "Erziehungsberechtigten entfernen?",
    removeAllGuardiansTitle: "Alle Erziehungsberechtigten entfernen?",
    removeGuardianDescription: "{{guardian}} als Erziehungsberechtigten von {{student}} entfernen?",
    ...
    removeGuardiansFailed: "Entfernen der Erziehungsberechtigten fehlgeschlagen",
    ...
    shareStep2: "Geben Sie den Beitrittscode ein — das Scannen des QR füllt ihn aus.",
    ...
    settingsDescription: "Klassenweite Optionen konfigurieren. Weitere Einstellungen folgen hier.",
  ...
  settings: {
    ...
    docDescription: "Verwalten Sie Ihre persönlichen Einstellungen für ClassClarus",
    title: "Einstellungen",
    description: "Verwalten Sie Ihre persönlichen Präferenzen.",
    languageLabel: "Sprache",
    languageDescription: "Ihre persönliche Sprache für die ClassClarus-Oberfläche.",
    themeLabel: "Design",
    themeDescription: "Wählen Sie Hell, Dunkel oder folgen Sie Ihrer Systemeinstellung.",
  },
  account: {
    ...
    paymentsComingSoon: "Zahlungen und Abrechnung werden hier verwaltet. Demnächst verfügbar.",
  },
};

...
const it: Catalog = {
  ...
  auth: {
    ...
    and: "e",
    googleOnlyNote: "Al momento supportiamo solo Google. Stiamo lavorando ad altre opzioni.",
  ...
  home: {
    ...
    sortByFieldActive: "Ordina per {{field}}, {{direction}}. Clic per invertire.",
    ...
    joinClassDescription: "Hai un codice dall’insegnante? Inseriscilo qui per unirti a una classe.",
  ...
  schools: {
    ...
    admins: "Admin",
    adminsDescription: "Proprietari, dirigenti, vicepresidi e admin che gestiscono questa scuola.",
  ...
  classes: {
    ...
    editDescription: "Aggiorna nome e descrizione. L’anno scolastico non può essere modificato.",
    nameLabel: "Nome",
    ...
    yearImmutable: "L’anno scolastico non può essere modificato dopo la creazione della classe.",
    ...
    deleteClassDescription: "Eliminare “{{name}}”? Questa azione non può essere annullata.",
    ...
    notFoundDescription: "La classe potrebbe essere stata eliminata oppure non hai accesso.",
    joinCodes: "Inviti",
    ...
    removeGuardianDescription: "Rimuovere {{guardian}} come tutore di {{student}}?",
    removeAllGuardiansDescription: "Rimuovere tutti i {{count}} tutori di {{student}}?",
  ...
  settings: {
    ...
    languageDescription: "La tua lingua personale per l’interfaccia di ClassClarus.",
    themeLabel: "Tema",
    themeDescription: "Scegli chiaro, scuro o segui le impostazioni di sistema.",
  },
  account: {
    ...
    paymentsComingSoon: "Pagamenti e fatturazione saranno gestiti qui. In arrivo.",
  },
};

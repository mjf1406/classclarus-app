...
const ru: Catalog = {
  ...
  auth: {
    ...
    and: "и",
    googleOnlyNote: "Сейчас поддерживается только Google. Мы работаем над другими вариантами.",
  ...
  home: {
    ...
    sortByFieldActive: "Сортировка по {{field}}, {{direction}}. Нажмите, чтобы изменить порядок.",
    viewGrid: "Сетка",
    viewList: "Список",
    archived: "В архиве",
    ...
    joinClassDescription: "Есть код от учителя? Введите его здесь, чтобы присоединиться к классу.",
  ...
  schools: {
    ...
    admins: "Админы",
    adminsDescription: "Владельцы, директора, завучи и администраторы, управляющие этой школой.",
  ...
  join: {
    ...
    description: "Используйте код учителя или приглашение опекуна, чтобы присоединиться.",
    ...
    invalidShareLink: "Недействительная ссылка. Попросите учителя новую ссылку с кодом.",
  ...
  classes: {
    ...
    editDescription: "Обновите название и описание. Учебный год изменить нельзя.",
    nameLabel: "Название",
    ...
    noStudentsYet: "Пока нет учеников. Они появятся здесь после вступления по коду ученика.",
    ...
    removeAllGuardiansDescription: "Убрать всех опекунов ({{count}}) у {{student}}?",
  ...
  account: {
    ...
    paymentsComingSoon: "Платежи и выставление счетов будут управляться здесь. Скоро.",
  },
};
